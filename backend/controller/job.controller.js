...
// basically for student who wants to find a job
...
export const updateJob = async (req, res) => {
    try {
        ...
        if (Array.isArray(location)) {
            updatedLocation = location.join(', ');  // Join the array into a string
        }

        const updateData = { title, description, requirements, salary, location:updatedLocation , jobType, experience, position };
